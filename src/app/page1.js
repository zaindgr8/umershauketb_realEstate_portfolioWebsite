                ...
                <div className="col-lg-10 col-xl-8">
                  <div className="row g-4 align-items-end newslatter-form">
                    ...
                    <div className="col-sm">
                      {/* Start Form Group */}
                      <div className="form-group">
                        <label className="text-white bg-primary">
                          Enter Email
                        </label>
                        <input
                          type="email"
                  ...
                  <small className="d-block mt-3 text-white text-center">
                    ...
                    Magni cum consectetur alias laudantium dolore sunt quis
                    similique!
                  </small>
                  {/* /. End Text */}
                </div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="sub-title fs-16">
                      ...
                      <br className="d-none d-lg-block" /> default model text,
                    ...
                    >
                      ...
                      >
                        <div className="card-body p-4 p-xxl-5">
                          ...
                          <p>
                            Lorem ipsum dolor amet consectetur cillum adipiscing
                            elit sed do eiusmod.
                          </p>
